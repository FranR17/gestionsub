  ...
  return (
    <div className="dash">
      ...
      <section className="dash-hero2">
        <p className="dash-hi">{greeting}</p>
      ...
      <section className="dash-section">
        ...
        <div className="dash-bars">
          {monthlyProjection.map((item) => (
            <div className="dash-bar-col" key={item.key}>
              <div className="dash-bar-track"><div className="dash-bar-fill" style={{ height: `${item.height}%` }} /></div>
